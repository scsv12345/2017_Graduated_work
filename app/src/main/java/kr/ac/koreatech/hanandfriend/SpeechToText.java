...
public class SpeechToText {
    ...
    private static final String WORD = RecognizerIntent.LANGUAGE_MODEL_WEB_SEARCH;
    private static final String SENTENCE = RecognizerIntent.LANGUAGE_MODEL_FREE_FORM;
    ...
    private class Listener implements RecognitionListener {
        ...
        public void onResults(Bundle bundle) {
            ...
            if(bundle.getStringArrayList(SpeechRecognizer.RESULTS_RECOGNITION).get(0)!=null)
